...
<%
	List<Invoice> list = InvoiceDao.getInvoices();
%>
...
<html>
  ...
  width: 6rem;font-size: 15px;padding: 7px 7px;margin-left:15px;border: 1.2px solid;"
      ...
      <h2 class="Invoice">ADD INVOICE</h2>
      <br />
      <div class="containerInvoice">
        <form class="form" action="AddInvoice" method="post">
          <input
            type="text"
          ...
          <button type="submit" class="invoiceBtn">Submit</button>
        </form>
      </div>
      <br />
      <br />
